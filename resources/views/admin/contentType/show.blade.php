<x-default-layout>
    ...
    <div class="row" dir="rtl">
        ...
        <div class="col-12 mt-12">
            <form  method="post" enctype="multipart/form-data" action="{{ route("contentType.update" , $data["content_type"]) }}">
                @csrf
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-3 col-12">
                        <div class="mb-10">
                            ...
                            <input type="text" name="name" id="nameFormControl" class="form-control" value="{{ $data["content_type"]->name }}" placeholder="دسته بندی"/>
                        </div>
                    </div>

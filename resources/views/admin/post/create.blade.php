                ...
                <div class="row">
                    <div class="col-10">
                        <div class="mb-10">
                            ...
                            <input type="text" name="title" id="nameFormControl" class="form-control" placeholder="عنوان"/>
                        </div>
                    </div>
                    <div class="col-2">
                          ...
                          <div class="row">
                              ...
                              <div class="col-6">
                                  <div class="form-check form-check-custom form-check-success form-check-solid">
                                      <input id="activeStatus" class="form-check-input" type="radio" name="status" value="1" checked />
                              ...
                              <div class="col-6">
                                  <div class="form-check form-check-custom form-check-danger form-check-solid">
                                      <input id="deActiveStatus" class="form-check-input" type="radio" name="status" value="0" />

...
Route::middleware(['auth:admins'])->group(function () {
    ...
    Route::controller(SliderController::class)->prefix('slider')->group(function () {
        Route::get('index', 'index')->name('slider.index')->can('slider read all');
        Route::get('create', 'create')->name('slider.create')->can('slider create');
        Route::post('store', 'store')->name('slider.store')->can('slider create');
        Route::get('edit/{slider}', 'edit')->name('slider.edit')->can('slider edit');
        Route::post('update/{slider}', 'update')->name('slider.update')->can('slider edit');
        Route::delete('delete/{slider}', 'delete')->name('slider.delete')->can('slider delete');
    });
    /*********************************
     * ****** slider Routes *******
     *********** END **************/
